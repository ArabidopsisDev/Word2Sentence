...
CUE_BEATS = {
    1: (0.2, 2.8), 2: (3.0, 5.8),
    3: (0.3, 3.0), 4: (3.2, 6.2), 5: (6.4, 9.7),
    6: (0.5, 4.5), 7: (4.7, 9.2), 8: (9.4, 14.7),
    9: (0.5, 4.5), 10: (4.8, 9.0), 11: (9.3, 14.0), 12: (14.3, 18.5), 13: (18.8, 23.6),
    14: (0.4, 3.8), 17: (4.0, 7.8), 20: (8.0, 11.7),
    26: (0.4, 4.0), 27: (4.2, 8.0), 28: (8.2, 12.7),
    21: (0.3, 2.6), 22: (2.8, 5.3), 24: (5.5, 7.9),
    25: (0.3, 4.8),
}
