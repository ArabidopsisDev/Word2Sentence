...
- 使用范围：97.9407–178.1007 秒，连续截取，无循环拼接
- 节拍：约 73.36 BPM
...
- SHA-256：`B42FCF75226C3133777D6597563DE5ECF8C0F2CAA917E388DF1C5C4FF7F10F62`
- 文件大小：9,043,527 bytes
- 实测综合响度：-18.02 LUFS
- 实测真峰值：-3.44 dBTP
- LRA：6.60 LU
- 淡出分段平均电平：-20.1 → -19.4 → -23.7 → -26.3 → -36.4 dB
- 完整解码：通过
- 内嵌字幕与软字幕流：0；容器中的 data track 仅用于章节
- 最终证明帧：6 项全部从正式 MP4 抽取，全部使用普通产品 UI 文本，不含源码证明层
- 独立审阅：文案、首次观看、技术、视觉几何全部通过；源码块、粗框、重影和错误遮挡均为 0
