...
- 使用范围：97.9407–182.9807 秒，连续截取，无循环拼接
- 节拍：约 73.36 BPM
...
- SHA-256：`787771FB88CF80FD370310752304F221C19ABA2B2332D7573DCEBF9E516CF08B`
- 文件大小：6,854,473 bytes
- 实测综合响度：-18.00 LUFS
- 实测真峰值：-3.44 dBTP
- LRA：6.60 LU
- 淡出分段平均电平：-21.3 → -20.1 → -24.6 → -25.1 → -37.9 dB
- 完整解码：通过
