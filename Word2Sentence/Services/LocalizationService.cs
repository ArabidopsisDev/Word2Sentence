...
public sealed class LocalizationService : INotifyPropertyChanged
{
    private static readonly IReadOnlyDictionary<string, (string Zh, string En)> Strings =
        new Dictionary<string, (string, string)>(StringComparer.Ordinal)
        {
            ...
            ["ModelId"] = ("模型 ID", "Model ID"), ["ModelHelp"] = ("默认 stealth/ox-alpha；后续可改为 deepseek/deepseek-v4-flash。", "Default: stealth/ox-alpha. You can later switch to deepseek/deepseek-v4-flash."),
            ...
            ["SentenceRequired"] = ("请先写一个完整句子。", "Write a complete sentence first."), ["CheckingSentence"] = ("正在检查语法、搭配和自然度…", "Checking grammar, collocation, and naturalness…"),
